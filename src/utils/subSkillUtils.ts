...
export const getRarityStyles = (rarity: Rarity) => {
  const styles = {
    gold: {
      ...
      chip: "bg-amber-200 text-amber-800 border-amber-400 dark:bg-amber-700/70 dark:text-amber-200",
    ...
    blue: {
      ...
      chip: "bg-cyan-200 text-cyan-800 border-cyan-400 dark:bg-cyan-700/70 dark:text-cyan-200",
    ...
    gray: {
      ...
      chip: "bg-gray-300 text-gray-800 border-gray-400 dark:bg-gray-600/80 dark:text-gray-200",
