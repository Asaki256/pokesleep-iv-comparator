...
export const getRarityStyles = (rarity: Rarity) => {
  const styles = {
    gold: {
      ...
      badge: "bg-yellow-500",
      hover:
        "hover:from-yellow-100 hover:to-amber-100 hover:border-amber-400 dark:hover:from-amber-700/80 dark:hover:to-yellow-700/80 dark:hover:border-amber-400",
      chip: "bg-amber-100 text-amber-700 border-amber-300 dark:bg-amber-700/70 dark:text-amber-200",
    ...
    blue: {
      ...
      badge: "bg-cyan-500",
      hover:
        "hover:from-cyan-100 hover:to-blue-100 hover:border-cyan-400 dark:hover:from-cyan-700/80 dark:hover:to-blue-700/80 dark:hover:border-cyan-400",
      chip: "bg-cyan-100 text-cyan-700 border-cyan-300 dark:bg-cyan-700/70 dark:text-cyan-200",
    ...
    gray: {
      ...
      chip: "bg-gray-100 text-gray-700 border-gray-300 dark:bg-gray-600/80 dark:text-gray-200",
